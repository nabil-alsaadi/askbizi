...
import { collapseAnimation, expandAnimation } from './collapsible-animation';

@Directive({
  selector: '[libCollapsible]',
...
export class CollapsibleDirective implements AfterViewChecked {
  /** This event fires as soon as content collapses */
  @Output() collapsed: EventEmitter<CollapsibleDirective> = new EventEmitter();
  /** This event fires when collapsing is started */
  @Output() collapses: EventEmitter<CollapsibleDirective> = new EventEmitter();
  /** This event fires as soon as content becomes visible */
  @Output() expanded: EventEmitter<CollapsibleDirective> = new EventEmitter();
  /** This event fires when expansion is started */
  @Output() expands: EventEmitter<CollapsibleDirective> = new EventEmitter();
  // shown
